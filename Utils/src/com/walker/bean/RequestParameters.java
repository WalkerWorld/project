...
import com.walker.http.BaseParser;
 ...
 */
	public RequestParameters(Context context,Map<String, String> requestDataMap, BaseParser<?> jsonParser) {
		super();
	 ...
	 * @param jsonParser 解析工具类
	 */
	public RequestParameters(String requestUrl, Context context,
